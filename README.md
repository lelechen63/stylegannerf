...
usage
```
CUDA_VISIBLE_DEVICES=2,3 python train.py --outdir=./checkpoints/ --data=/data/home/uss00022/lelechen/data/Facescape/textured_meshes --cfg=face256 --gpus=2 --aug=noaug
```
